            ...
            <div className="flex gap-4">
              <div className="w-1/2 ">
                <div className="sticky top-[12px] ">
                  <div className="flex items-center justify-center rounded-md bg-white overflow-hidden">
                  ...
                  <div className="flex mt-3 flex-col gap-3 bg-white rounded-md p-4">
                    ...
                    <div>
                      <div className="border-b border-gray-200 p-3 flex gap-2">
                        <span className="text-[18px]">Thời gian bảo hành:</span>
            ...
            <div className=" sticky top-[12px]">
              <div className=" flex flex-col gap-4 bg-white rounded-md p-4">
                ...
                <div className="space-y-2">
                  ...
                  >
                    {isCart ? "Đã thêm vào giỏ hàng" : "Thêm vào giỏ hàng"}
                  </div>
                </div>
              </div>
              <div className="mt-4">
